...
manage_students() {
  ...
  case $choice in
    ...
    3)
      ...
      ;;
    4) admin_menu ;;
    *) echo "Invalid choice!"; pause; manage_students ;;
  esac
}
...
manage_courses() {
  ...
  case $choice in
    ...
    3)
      ...
      # Delete attendance related to this course
      grep -v ":$cid_del:" $ATTENDANCE > tmp && mv tmp $ATTENDANCE
      # Delete grades related to this course
      ...
      ;;
    4) admin_menu ;;
    *) echo "Invalid choice!"; pause; manage_courses ;;
  esac
}
  ...
  case $choice in
    ...
    3)
      ...
      if grep -q "^$sid:$cid$" $ENROLLMENTS; then
        ...
        # Also remove attendance and grades related to this enrollment
      ...
      ;;
    4) admin_menu ;;
    *) echo "Invalid choice!"; pause; manage_enrollments ;;
  esac
}
...
enter_grades() {
  ...
  # Remove previous grade record for this student-course if any
  grep -v "^$sid:$cid:" $GRADES > tmp && mv tmp $GRADES
...
student_menu() {
  ...
  echo "=== Student Menu ==="
  echo "1) View Profile"
  echo "2) View Enrolled Courses"
  echo "3) View Attendance"
  echo "4) View Grades"
  echo "5) Logout"
  read -p "Choose: " choice
  case $choice in
    1) view_profile "$username" ;;
    2) view_enrolled_courses "$username" ;;
    3) view_attendance "$username" ;;
    4) view_grades "$username" ;;
    5) welcome_screen ;;
